...
# convert high elevation pixels into polygon shapes and then transform into a simple feature (sf)
...
```{r}
# define a bounding box coordinates for our area of interest
...
# bounding box from open street map
...
# creat a combined trails layer with different styles for each type
