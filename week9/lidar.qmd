...
eaton_perimeter <- st_read(here::here( "week9", "data","Eaton_Perimeter_20250121 2", "Eaton_Perimeter_20250121.shp"))%>% st_transform(crs = crs(dsm_post))
```
...
# Remove values outside of the upper and lower quartile
...
overlay <- height_shade(
  diff_mat,
  texture = colorRampPalette(c("#8B0000", "#FF6347", "#FFFFFF", "#87CEEB", "#00008B"))(256),
  range = c(-20, 20)
)
# 256 is the number of brightness levels
# create 256 color values between our color scale

# Create map will hillshade
elev_mat %>% 
