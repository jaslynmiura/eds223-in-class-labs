...
filelist <- list.files(here::here("eds223-in-class-labs", "week8", "data", "landsat-data"), full.names = TRUE)
...
SB_county_south <- st_read(here::here("eds223-in-class-labs", "week8", "data", "SB_county_south.shp")) %>%
...
# going to be a box around the shapefile, mask crops the raster to boundary
...
# remove some uncecessary objects from environment
...
# adjust values based on the scaling factor
...
training_data <- st_read(here::here("eds223-in-class-labs", "week8", "data", "trainingdata.shp")) %>%
...
# join training data attributes and extracted relectance values
...
# update cells with culster value
values(SB_classification_kmeans)[cells] <- landsat_df$culster
